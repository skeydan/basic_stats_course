...
Now we can compare the means - and the mean of means - with the theoretical mean of the exponential(0.2) distribution, which is equal to the 1 over the parameter lambda:
